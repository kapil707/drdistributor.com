						...
						<div class="row">
							...
							<div class="col-sm-12 import_order_main_${item_id}'" style="display:none">
								<div class="import_order_box_left_div web-col-padding-0">
									...
									<img src="<?= base_url(); ?>assets/<?php echo $this->appconfig->getWebJs(); ?>/images/out_of_stock_img.png" class="import_order_item_out_of_stock_img import_order_item_out_of_stock_${item_id}'" style="display:none">
