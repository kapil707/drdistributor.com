...
<div class="container maincontainercss">
	...
	<div class="row">
		...
		<div class="col-sm-8 col-12">
			...
			<div class="row website_box_part">51
					...
					<div class="main_theme_li_bg p-4">
						...
						<div class="row">
							...
							<div class="col-sm-10 col-10 text-left">
								...
								<span class="chemist_altercode"51r_altercode'] ?></span>
				...
				<div class="col-sm-12 m-2">
					...
					<div class="main_theme_li_bg p-4">
						...
						<a href="<?= base_url('home/change_image')?>" title="Update Image">
							...
							<span style="margin-left:20px;">Update image</span>51
