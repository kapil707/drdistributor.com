				...
				$.each(data.items, function(i,item){
						if (item)
						{
							...
							if(item_featured=="1" && item_quantity!="0"){
								item_other_image_div = '<img src="<?= base_url() ?>img_v51/featured_img.png" class="all_item_featured_img" width="40px">';
							}
							...
							if(item_quantity=="0"){
								...
								item_other_image_div = '<img src="<?= base_url() ?>img_v51/out_of_stock_img.png" class="all_item_out_of_stock_img" width="40px">';
							}
