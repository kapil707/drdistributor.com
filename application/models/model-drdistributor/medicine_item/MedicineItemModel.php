...
class MedicineItemModel extends CI_Model  
{
	...
	public function medicine_item($session_yes_no="no",$category_id,$user_type='',$user_altercode='',$salesman_id='',$show_out_of_stock="0",$get_record="12",$limit="12",$order_by_type="RAND")
	{
		if($category_id=="1"){
			return $this->MedicineNewThisMonthModel->get_medicine_new_this_month_api($session_yes_no,$category_id,$show_out_of_stock,$get_record,$limit,$order_by_type);
		}
		if($category_id=="2"){
			return $this->MedicineHotSellingModel->get_medicine_hot_selling_api($session_yes_no,$category_id,$show_out_of_stock,$get_record,$limit,$order_by_type);
		}
		if($category_id=="3"){
		...
		if($category_id=="7"){
			return $this->MedicineSchemeNewModel->get_medicine_scheme_now_api($session_yes_no,$category_id,$show_out_of_stock,$get_record,$limit,$order_by_type);
		}
		
		return $this->MedicineItemWiseModel->get_medicine_item_view_api($session_yes_no,$category_id,$show_out_of_stock,$get_record,$limit,$order_by_type);
	}
