...
51
				...
				<div data-u="arrowleft" class="jss51;height:65px;top:0px;left:35px;" data-autocenter="2" data-scale="0.75" data-scale-left="0.75">
...
51
		...
		<div class="col-xs-12 col-sm-12 col-12">
			...
			<div class="home_menu_main_div wow fadeInDown animated">
...
51
		...
		<div class="col-sm-6 wow fadeInLeft animated" data-wow-duration="2s" data-wow-delay="5s">
...
51
		<div class="col-sm-6 wow fadeInRight animated" data-wow-duration="2s" data-wow51
	...
	<?php if($row->type=="divisioncategory"){ ?>
		...
		<div class="col-xs-12 col-sm-12 col-12 divisioncategory_div_<?php echo $row->category_id ?>">

			<div class="featured_home_title1">
			...
			<div class="row">
				...
				<div class="col-sm-5">
					...
					<img src="<?php echo base_url(); ?>img_v<?= constant('site_v') ?>/heart.png" width="100%" class="wow fadeInLeft animated" data-wow-duration="2s" data-wow-delay="5s">
				...
				<div class="col-sm-7">
					...
					<div class="featured_home" id="featured_home">
						...
						<ul class="divisioncategory_css divisioncategory_result_<?php echo $row->category_id ?>">
