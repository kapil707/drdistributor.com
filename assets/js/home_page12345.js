...
function home_page_slider(category_id,items,title){
	...
	myval = '<div class="col-xs-12 col-sm-12 col-12 col-padding-5"><div id="jssor_'+category_id+'"><div data-u="slides" class="top_flash_div">'+mydata+'</div><div data-u="navigator" class="jssorb051" style="position:absolute;bottom:12px;right:12px;" data-autocenter="1" data-scale="0.5" data-scale-bottom="0.75"><div data-u="prototype" class="i" style="width:16px;height:16px;"><svg viewbox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;"><circle class="b" cx="8000" cy="8000" r="5800"></circle></svg></div></div><div data-u="arrowleft" class="jssora_arrowleft" style="top:0px;left:35px;" data-autocenter="2" data-scale="0.75" data-scale-left="0.75"><</div><div data-u="arrowright" class="jssora_arrowright" style="top:0px;right:35px;" data-autocenter="2" data-scale="0.75" data-scale-right="0.75">></div></div></div>';
...
function home_page_invoice(category_id,items,title){
	...
	myval = '<div class="col-sm-6 wow fadeInLeft animated col-padding-5" data-wow-duration="0.10s" data-wow-delay="0.2s"><div class="home_page_heading_title2"><a href="'+get_base_url()+'my_invoice" title="My invoice">My invoice</a></div><div class="">'+mydata+'</div></div>';
...
function home_page_notification(category_id,items,title){
	...
	myval = '<div class="col-sm-6 wow fadeInRight animated col-padding-5" data-wow-duration="0.10s" data-wow-delay="0.2s"><div class="home_page_heading_title2"><a href="'+get_base_url()+'my_notification" title="My notification">My notification</div><div class="">'+mydata+'</div></div>';
