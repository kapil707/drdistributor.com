...
$route['invoice/(:any)/(:any)'] = 'User/invoice/$1/$2';
...
$route['medicine_category/(:any)']          = 'medicine_category/index/$1';
$route['medicine_category/featured_brand/(:any)']   = 'medicine_category/index/$1/$2';
