...
51
				...
				<div data-u="navigator" class="jss51bsolute;bottom:12px;right:12px;" data-autocenter="1" data-scale="0.5" data-scale-bottom="0.75">
...
51
				...
				<div data-u="arrowright" class="js51x;height:65px;top:0px;right:35px;" data-autocenter="2" data-scale="0.75" data-scale-right="0.75">
			...
			<div id="flash2" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
					...
					foreach($top_flash2 as $row1) { ?>
						...
						<div class="carousel-item <?php echo $row1["id"]; ?>">
...
51
		...
		<div class="col-xs-12 col-sm-12 col-12" style="margin-top:10px;">
								...
								<div class="content">
									...
									<a href="javascript:void(0)" onClick="medicine_details_funcation('<?php echo $row1["item_code"] ?>')" title="<?php echo $row1["item_name"] ?> (<?php echo $row1["item_packing"] ?> Packing)"	>
										...
										<div class="home_page_item_name">
											...
											<span class="home_page_iitem_packing"> 
