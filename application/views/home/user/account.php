	...
	<div class="row">
		...
		<div class="col-sm-8 col-12">
			<div class="row website_box_part">
				...
				<div class="col-sm-12 m-2">
					<div class="main_theme_li_bg p-4">
						<a href="<?= base_url('home/change_password')?>" title="Update Pas51
		...
		success    : function(data){
			...
			$.each(data.items, function(i,item){	
				if (item){		
					...
					$(".load_page").append('<div class="row"><div class="col-sm-10 col-10"><img class="img-circle" src="<?= base_url() ?>/img_v51/phone1.png" width="25" alt="Mobile" title="Mobile"><span style="margin-left:20px;">'+item.mobile+'</span></div><div class="col-sm-2 col-2"><span class="text-right"><a href="<?= base_url(); ?>home/change_account" title="Update account"> <img class="img-circle" src="<?= base_url() ?>/img_v51/edit_icon.png" width="20" alt="Update account" title="Update account"></a></span></div></div>');
					$(".load_page").append('<div class="row"><div class="col-sm-12"><img class="img-circle" src="<?= base_url() ?>/img_v51/email1.png" width="25" alt="Email" title="Email"><span style="margin-left:20px;">'+item.email+'</span></div></div>');
					$(".load_page").append('<div class="row"><div class="col-sm-12"><img class="img-circle" src="<?= base_url() ?>/img_v51/map1.png" width="25" alt="Address" title="Address"><span style="margin-left:20px;">'+item.address+'</span></div></div>');
				}
			});
		},
		timeout: 10000
