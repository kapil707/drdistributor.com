						...
						<td class="import_order_td_<?= $i ?>">
							<div class="row">
								...
								<div class="col-sm-11">
									<div class="row">
										<div class="col-sm-8">
											...
											<i class="fa fa-trash-o all_item_delete_btn" aria-hidden="true" style="margin-right:5px;"></i> Delete medicine</a>
											</span>
										</div>
								...
								<div class="col-sm-12">
									...
									|
										<a href="javascript:delete_suggested_medicine('<?= $i ?>')" title="Delete suggested medicine" class="all_item_delete_btn"><i class="fa fa-trash-o all_item_delete_btn" aria-hidden="true" style="margin-right:5px;"></i>Delete suggested medicine</a>
									</span>
								</div>
							</div>
