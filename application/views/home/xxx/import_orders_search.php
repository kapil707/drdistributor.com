						...
						<td class="import_order_td_<?= $i ?>">
							...
							<div class="row">
								...
								<div class="col-sm-1">
									...
									<img src="<?=base_url(); ?>img_v<?51ogo2.png" width="60px;" style="margin-top: 5px;" class="image_css_<?= $i ?>" alt="">
...

{
	...
	swal({
		...
		title: "Are you sure to delete medicine?",51
