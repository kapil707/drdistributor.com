	...
	<div class="row">
		...
		<div class="col-sm-8 col-12">
			<div class="row main_box_div p-2">
				...
				<div class="col-sm-12">
					<img src="<?= base_url(); ?>assets/<?php echo $this->appconfig->getWebJs(); ?>/images/b_lock.png" width="25px" style="float: left; margin-top: 7px;position: absolute;margin-left: 10px;" alt>
					...
					<div style="float: right; margin-top: 10px;margin-left: -50px; width:45px;">
						<img src="<?= base_url(); ?>assets/<?php echo $this->appconfig->getWebJs(); ?>/images/b_eyes1.png" width="25px" onclick="showpassword()" id="eyes1" alt>
						<img src="<?= base_url(); ?>assets/<?php echo $this->appconfig->getWebJs(); ?>/images/b_eyes.png" width="25px" onclick="hidepassword()" id="eyes" style="display:none" alt>
					</div>
				</div>
				<div class="col-sm-12 mt-2">
				...
				<div class="col-sm-12">
					...
					<div style="float: right; margin-top: 10px;margin-left: -50px; width:45px;">
						<img src="<?= base_url(); ?>assets/<?php echo $this->appconfig->getWebJs(); ?>/images/b_eyes1.png" width="25px" onclick="showpassword1()" id="eyes1" alt>
						<img src="<?= base_url(); ?>assets/<?php echo $this->appconfig->getWebJs(); ?>/images/b_eyes.png" width="25px" onclick="hidepassword1()" id="eyes" style="display:none" alt>
					</div>
				</div>
				<div class="col-sm-12 mt-2">
				...
				<div class="col-sm-12">
					...
					<div style="float: right; margin-top: 10px;margin-left: -50px; width:45px;">
						<img src="<?= base_url(); ?>assets/<?php echo $this->appconfig->getWebJs(); ?>/images/b_eyes1.png" width="25px" onclick="showpassword2()" id="eyes1" alt>
						<img src="<?= base_url(); ?>assets/<?php echo $this->appconfig->getWebJs(); ?>/images/b_eyes.png" width="25px" onclick="hidepassword2()" id="eyes" style="display:none" alt>
					</div>
				</div>
...
<script src="<?php echo base_url(); ?>/assets/<?php echo $this->appconfig->getWebJs(); ?>/js/user/update_password.js"></script>