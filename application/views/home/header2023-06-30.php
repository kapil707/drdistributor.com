...
<head>
	...
	:root{
		...
		--item_mrp_color:#795548;51

		--item_price_color:#6c757d;51
...
51
	...
	<link href="<?= base_url(); ?>ass51constant('site_v') ?>.css" rel="stylesheet" type="text/css"/>
...
$website_menu 	= json_decode($website_menu, true);51
...

{
	...
	$.ajax({
		...
		data       :  { theme_set_css:theme_s51

		url        : "<?php echo base_url(); 51,
