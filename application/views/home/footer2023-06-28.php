	...
	<div class="container">
		<div class="row">
			<div class="col-sm-12">
				...
				<div class="div_width_25par">
					<ul>
						...
						<li class="footer_li_left"><img src="<?= base_url() ?>img_v51/insta.svg"></li>
						<li class="footer_li_left"><img src="<?= base_url() ?>img_v51/fb.svg"></li>
						<li class="footer_li_left"><img src="<?= base_url() ?>img_v51/youtube.svg"></li>
						<li class="footer_li_left"><img src="<?= base_url() ?>img_v51/twitter.svg"></li>
					<ul>
				</div>
			</div>
			...
			<div class="text-center" style="margin-top:15px;">
					<img src="<?= base_url() ?>img_v51/logo2.png" class="img-fluid" style="margin-top: 5px;" alt width="100px;">
				</div>
				<div class="text-center" style="margin-top:15px;">
...
<div class="fix_footer mobile_show">
	<div class="div_width_20par text_cut_or_dot mobile_footer_css_ok text-center">
		<a href="<?= base_url('home/account')?>" style="color:white">
			<img src="<?= base_url() ?>img_v51/my_account.png" width="22px" alt>
	...
	<div class="div_width_20par text_cut_or_dot mobile_footer_css_ok_left text-center">
		<a href="<?= base_url('home/track_order')?>" style="color:white">
			<img src="<?= base_url() ?>img_v51/map.png" width="22px" alt>
	...
	<div class="div_width_20par text_cut_or_dot mobile_footer_css_ok_right text-center">
		<a href="<?= base_url('home/my_notification')?>" style="color:white">
			<img src="<?= base_url() ?>img_v51/notification.png" width="22px" class="cssnotification" alt>
			<img src="<?= base_url() ?>img_v51/notification1.png" width="22px" style="display:none;" class="cssnotification1" alt>
	...
	style="margin-right: -15px;">
		<a href="<?= base_url();?>/home" style="color:white">
			<img src="<?= base_url() ?>img_v51/reload1_w.png" width="22px" alt>
