	...
	if(query_work=="0")
	{
		...
		$.ajax({
			...
			error: function(){
				...
				$(".load_page").html('<h2><img src="<?= base_url(); ?>img_v51/something_went_wrong.png" width="100%"></h2>');
			},
			success    : function(data){

				$(".load_page_loading").html("");				
				if(data.items=="" && no_record_found=="0") {
					$(".main_page_loading").html('<h2><center><img src="<?= base_url(); ?>/img_v51/no_record_found.png" width="100%"></center></h2>');
				}
