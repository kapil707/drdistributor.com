...
<head>
	...
	<?php if($theme_type=="lite") { ?>
		<link href="<?= base_url(); ?>assets/css/style-light112345.css" rel="stylesheet" type="text/css"/>
	<?php } ?>

	<?php if($theme_type=="dark") { ?>
		<link href="<?= base_url(); ?>assets/css/style-dark112345.css" rel="stylesheet" type="text/css"/>
	<?php } ?>

	<link href="<?= base_url(); ?>assets/css/style112345.css" rel="stylesheet" type="text/css" />
