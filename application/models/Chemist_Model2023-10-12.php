...
if ($items != '') {
	...
	{		
		...
		if(!empty($row->id))
		{
			...
			if($item_quantity==0)
			{
				$this->add_low_stock_alert($user_type,$user_altercode,$salesman_id,$item_code);
			}
...
if ($items != '') {
	...
	public function medicine_new_mrp_json_50($session_yes_no="no",$category_id)
	{
		...
		$sameid = "";
		$query = $db2->query("select DISTINCT i_code from tbl_final_comparer where type='mrp' ORDER BY RAND() limit 12")->result();
		foreach ($query as $row)
		{
			$sameid.=$row->i_code.",";
		}
...
if ($items != '') {
	...
	public function medicine_new_scheme_json_50($session_yes_no="no",$category_id)
	{
		...
		$sameid = "";
		$query = $db2->query("select DISTINCT i_code from tbl_final_comparer where type='margin' ORDER BY RAND() limit 12")->result();
		foreach ($query as $row)
		{
			$sameid.=$row->i_code.",";
		}
...
if ($items != '') {
	...
	public function stock_now_available_json_50($session_yes_no="no",$category_id)
	{
		...
		$query = $db2->query("select DISTINCT i_code from tbl_final_comparer where type='batchqty' ORDER BY RAND() limit 12")->result();
		foreach ($query as $row)
		{
			$sameid.=$row->i_code.",";
		}
...
if ($items != ''){
	...
	public function add_low_stock_alert($user_type,$user_altercode,$salesman_id,$item_code)
	{
