...
51
				...
				<div data-u="arrowleft" class="jss51;height:30px;top:0px;left:35px;background: black;border-radius: 30px;" data-autocenter="2" data-scale="0.75" data-scale-left="0.75">
...
51
		...
		<div class="col-xs-12 col-sm-12 col-51d" data-wow-duration="0.1s" data-wow-delay="0.2s">		
			...
			<div id="jssor_2">
				...
				<div data-u="navigator" class="jssorb051" style="position:absolute;bottom:12px;right:12px;" data-autocenter="1" data-scale="0.5" data-scale-bottom="0.75">
					...
					<div data-u="prototype" class="i" style="width:16px;height:16px;">
						...
						<svg viewbox="0 0 16000 16000" style="position:absolute;top:0;lef51%;">
		...
		<div class="col-xs-12 col-sm-12 col-12">
			...
			<div class="row">
				...
				<div class="col-xl-3 col-lg-3 col-md-4 col-sm-5 col-xs-12 col-12">
					...
					<img src="<?php echo base_url(); ?>img_v<?= constant('site_v') ?>/heart.png" width51Left animated" data-wow-duration="0.4s" data-wow-delay="0.5s">
