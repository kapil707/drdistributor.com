                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    ...
                                    <div class="import_order_box_right_div web-col-padding-0">
                                        <div class="row">
                                            <div class="col-sm-9">    
                                                ...
                                                <input type="hidden" value="${item_name}" class="import_order_hidden_item_name_${item_id}" />
                                                <input type="number" name="item_qty[]" value="${item_quantity}" 
                                                    class="import_order_quantity_textbox_${item_id} import_order_item_order_quantity_textbox" 
                                                    style="width:100px;" placeholder="Eg 1,2" 
                                                    onchange="import_order_row_quantity_change(${item_id})" 
                                                    title="Order quantity" min="1" max="1000" maxlength="4" />
                                                <span>                
                                                    <a href="javascript:void(0)" onclick="import_order_row_delete(${item_id})" 
                                                        title="Delete" class="import_order_delete_btn">
                                    ...
                                    <div class="col-sm-12 import_order_main_${item_id}" style="display:none">
                                        <div class="import_order_box_left_div web-col-padding-0">
                                            <img src="${get_base_url()}assets/${getWebJs()}/images/featured_img.png" 
                                                class="import_order_item_featured_img import_order_item_featured_${item_id}" style="display:none">
                                            <img src="${get_base_url()}assets/${getWebJs()}/images/out_of_stock_img.png" 
                                                class="import_order_item_out_of_stock_img import_order_item_out_of_stock_${item_id}" style="display:none">
                                            <img src="${get_base_url()}assets/${getWebJs()}/images/logo4.png" width="60px;" 
                                                class="all_item_image import_order_item_image_${item_id}" alt="">
                                        </div>
                                        <div class="import_order_box_right_div web-col-padding-0">
                                            <div class="row">
                                                <div class="col-sm-8">
                                                ...
                                                <div class="col-sm-4 text-right">
                                                    ...
                                                    <span class="all_item_mrp">
                                                        ...
                                                        <span class="import_order_item_mrp_${item_id}">0.00</span>/-
                                                    </span>
                                                </div>
                                                <div class="col-sm-12">
                                                ...
                                                <div class="col-sm-7">
                                                    ...
                                                    <span class="all_item_batch_no"> 
                                                        Batch no : <span class="import_order_item_batch_no_${item_id}"></span>
                                                    </span>
                                                ...
                                                <div class="col-sm-12">
                                                    <span class="cart_description1 import_order_item_message_${item_id}"></span>
                                                    <span>
                                                        <a href="javascript:import_order_medicine_change(${item_id})" 
                                                            class="import_order_edit_btn" title="Change medicine">
