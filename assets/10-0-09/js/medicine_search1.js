		...
		success: function(data){
			...
			$.each(data.items, function(i,item){
				if (item)
				{
					...
					div_all_data = "<div class='medicine_details_all_data_"+item_code+"' item_image='"+item_image+"' item_name='"+item_name+"' item_packing='N/a' item_batch_no='xxxxxx' item_expiry='00/00' item_company='N/a' item_quantity='0' item_stock='' item_ptr='0' item_mrp='0' item_price='0' item_gst='0' item_scheme='0+0' item_margin='0' item_featured='0' item_description1='' similar_items=''></div>"
