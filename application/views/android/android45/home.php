...
51
									...
									<div class="content" style="padding-top:5px;">
										...
										<a href="<?= base_url(); ?>51row["item_code"]; ?>/<?= $row["item_division"]; ?>">
...
51
							...
							if($item_quantity==0) {
								...
								$item_other_image_div = '<img src="'.base_url().'img_v'.constant("site_51g" class="medicine_cart_item_out_of_stock_img">';
