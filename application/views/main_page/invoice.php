	...
	<div class="row">
		...
		<div class="col-sm-12 col-12">
			<div class="row">
				...
				<div class="col-sm-12 col-12 text-center div_item_edit" style="display:none;margin-top:10px;margin-bottom:10px;">
					<h4>Item Quantity changed</h4>
				</div>
				<div class="col-sm-12 col-12">
					<div class="website_box_part load_page_edit" style="display:none"></div>
				</div>
				<div class="col-sm-12 col-12 text-center div_item_delete" style="display:none;margin-top:10px;margin-bottom:10px;">
					<h4>Items deleted</h4>
				</div>
				<div class="col-sm-12 col-12">
					<div class="website_box_part load_page_delete" style="display:none"></div>
				</div>
			</div>
		</div>
	</div>
