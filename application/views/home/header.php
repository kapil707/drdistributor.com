...
<head>
	...
	<meta name="author" content="<?= $this->Scheme_Model->get_website_data("seo_author") ;?>">

	<meta name="description" content="<?= $this->Scheme_Model->get_website_data("seo_description") ;?>" />

	<meta name="keywords" content="<?= $this->Scheme_Model->get_website_data("seo_keywords") ;?>" />
	
	<?= $this->Scheme_Model->get_website_data("seo_google") ;?>
